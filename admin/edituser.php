...
<?php 
  ...
  move_uploaded_file($_FILES["image"]["tmp_name"],"img/".$_FILES["image"]["name"]);
    ...
    $sql = "UPDATE `tbluseraccount` SET `U_NAME`='".$_POST['U_NAME']."', `U_USERNAME`='".$_POST['U_USERNAME']."', `UPASS`='".$_POST['UPASS']."', `UPIC`='".$location."' WHERE USERID=".$_POST['USERID'];
...
<div class="row">
      <div class="panel-body">
        <h1 class="page-header">Update Picture</h1>
        ...
        <div class="form-group">
              ...
              <div class="col-md-8">
                <input name="USERID" type="hidden" value="<?php echo $row['USERID'] ;?>">
                 <input class="form-control input-sm" id="U_NAME" name="U_NAME" placeholder=
                    "Account Name" type="text" value="<?php echo $row['U_NAME'] ;?>">
              </div>
            </div>
          </div>
              ...
              <div class="col-md-8">
                <input name="deptid" type="hidden" value="">
                 <input class="form-control input-sm" id="U_USERNAME" name="U_USERNAME" placeholder=
                    "Username" type="text" value="<?php echo $row['U_USERNAME'] ;?>">
              </div>
            </div>
          </div>
          ...
          <div class="form-group">
            <div class="col-md-8">
              ...
              <div class="col-md-8">
			 <a href ="index.php"><div class="col-md-8"><img src="<?php echo $_SESSION['UPIC'];?>"width="250" height="250" alt="" style="border-radius: 200%;
    background: #1ec3db;
    padding: 4px; 
    width: 200px;
    height: 160px;" 
 />
   <input type="file" name="image" value="" id="image"></div></a>
