...
<!-- Navigation
 ...
 <?php 
  ...
  move_uploaded_file($_FILES["image"]["tmp_name"],"img/".$_FILES["image"]["name"]);
    ...
    $sql = "INSERT INTO `tblpackage` (PACKAGE,`CATEGORY`, `PHOTOGRAPHER`, `PHOTOBOOK`, `MAXPHOTO`, `COVERAGE`,PRICE,`PIC`)  VALUES ('".$_POST['PACKAGE']."','".$_POST['CATEGORY']."','".$_POST['PHOTOGRAPHER']."','".$_POST['PHOTOBOOK']."','".$_POST['MAXPHOTO']."','".$_POST['COVERAGE']."','".$_POST['PRICE']."','".  $location."')"; 
...
<div class="row">
      <div class="panel-body">
        <h1 class="page-header">New Services</h1>
