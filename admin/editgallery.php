...
<?php 
  ...
  move_uploaded_file($_FILES["image"]["tmp_name"],"img/".$_FILES["image"]["name"]);
    ...
    $sql = "UPDATE `tblgallery` SET `CATEGORY`='".$_POST['CATEGORY']."', `CAPTION`='".$_POST['CAPTION']."', `LOCATION`='".$location."' WHERE ID=".$_POST['ID'];
